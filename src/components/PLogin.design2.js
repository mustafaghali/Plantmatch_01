...
// }
    ...
    return (
              ...
              <View style = {{flex:1}}>
                ...
                <LinearGradient colors={['#ffffff',colors.main]} style={{height:Dimensions.get('window').height-StatusBar.currentHeight,alignItems:'center',justifyContent:'space-around'}}>
                {/* ['#373b44','#73c8a9'] */}
                {/* ['#abbaab','#ffffff'] */}
                {/* ['#73c8a9','#ffffff'] */}
                ...
                <Image 
                  ...
                  <TextInput 
                    style = {{
                      ...
                      height : 50,
                      backgroundColor:'rgba(233, 226, 226,0.6)',
                      borderRadius:10,
                      alignItems:'center',
                  ...
                  />
                   ...
                   <TouchableOpacity  style = {styles.ButtonLogin}
                      ...
                      >
                        <Text style={{color:colors.whiteShadow,fontWeight:'900',fontFamily:'Roboto_medium',fontSize:25}}> {'GO !'} </Text>
                    </TouchableOpacity>    
